...
"""jj
hs1 = hostdetails("10.172.109.23","Administrator@skyscraper.local","vc_password","Datacenter3","cls","vmnic1","vmhba2")
hs2 = hostdetails("10.172.109.23","Administrator@skyscraper.local","vc_password","Datacenter3","cls","vmnic1","vmhba2")

src = "w1-hs4-n2203.eng.vmware.com"
dest = "w1-hs4-n2205.eng.vmware.com"
"""

hs1 = hostdetails("10.199.24.1","Administrator@vsphere.local","vc_password","Datacenter3","cls","vmnic1","vmhba64")
hs2 = hostdetails("10.199.24.1","Administrator@vsphere.local","vc_password","Datacenter3","cls","vmnic1","vmhba64")
...
def getFiles(host, file):
    ...
    try:
        ...
        srv = pysftp.Connection(host=host, username="root", password="esx_password", cnopts=cnopts)
