...
def TopData(logger, host,):
    ...
    try:
        ...
        exit_status, stdout0, stderr0 = customssh.CustomRunSsh(removefile,host,"root","esx_password")
        ...
        while True:
            ...
            exit_status, stdout0, stderr0 = customssh.CustomRunSsh(generatedata, host, "root", "esx_password")
