        ...
        for host, dsnames in datastoreinfo.items():
            ...
            try:
                ...
                for nicresult in nicresults:
                    ...
                    host_nic.setdefault(host, []).append({"Time": time_val, "Bandwidth": nicresult[1], "vnic": vnic , "vnicmax" : maxspeed})
                ...
                for ds in finalds:
                    ...
                    for result in results:
                        host_ds.setdefault(ds, []).append(
                            {"Time": int(result[0]) * 1000, "Read": result[1], "Write": result[2], "Host" :result[3]})
